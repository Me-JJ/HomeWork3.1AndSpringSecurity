...
public class PermissionMapping
{
    private static final Map<Role, Set<Permission>> permissionMapping = Map.of(
            Role.PROF,Set.of(Permission.PROF_VIEW,Permission.STUDENT_VIEW,Permission.SUBJECT_VIEW),
            Role.STUDENT,Set.of(Permission.PROF_VIEW,Permission.STUDENT_VIEW,Permission.SUBJECT_VIEW),
            Role.ADMIN,Set.of(Permission.PROF_VIEW,Permission.STUDENT_VIEW,Permission.SUBJECT_VIEW
            ,Permission.UPDATE,Permission.CREATE,Permission.READ,Permission.DELETE)
    );
